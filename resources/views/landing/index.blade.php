...
@extends('layouts.app') {{-- Jika pakai layout utama --}}
@section('content')
<!-- Bootstrap 5 CDN -->
...
<!-- (Opsional) Tambahkan CSS custom -->
<link rel="stylesheet" href="{{ asset('css/style.css') }}">
</head>
<body>

<!-- NAVBAR  -->
<nav id="navbar" class="navbar navbar-expand-lg p-0 sticky-top" style="background: white;">
...
<div class="bg-white text-black d-flex justify-content-end align-items-center pe-4 py-2 flex-grow-1" style="width: 40%";>
    <ul class="navbar-nav flex-row gap-4" id="navLinks">
        <li class="nav-item position-relative">
            <a class=" nav-link text-black fw-semibold" href="#">Beranda</a>
        </li>
        <li class="nav-item position-relative">
            <a class=" nav-link text-black fw-semibold" href="#">Alur</a>
        </li>
        <li class="nav-item position-relative">
            <a class=" nav-link text-black fw-semibold" href="#">Tentang Kami</a>
        </li>
        <li class="nav-item">
            {{-- <a class=" nav-link text-black fw-semibold" href="#">Masuk</a> --}}
            <a class="btn btn-primary" href="login.custom" role="button">Masuk</a>
        </li>
    </ul>
</div>
    </div>
...
<!-- HERO SECTIN -->
<section class="hero-section bg-white py-5 position-relative overflow-hidden">
    ...
    <div class="border-start ps-3">
        ...
        <p class="mb-0 small text-uppercase">PROVINSI SUMATERA BARAT</p>
            ...
            <p>Kesempatan magang bersama kami!
                <br>Diskominfo Kota Bukittinggi membuka program magang bagi siswa SMK dan mahasiswa dari berbagai jurusan. Peserta tidak perlu memilih posisi, karena penempatan akan ditentukan oleh Diskominfo setelah dinyatakan diterima.</br>
...
<div class="d-flex justify-content-center align-items-center gap-3 flex-wrap mb-3">
    ...
    'icon' => 'masuk.png', 
    'title' => 'Masuk', 
    'desc' => 'Masuk dan bikin akun terlebih dahulu'])
    ...
    'icon' => 'isi_form.png', 
    'title' => 'Isi form', 
    'desc' => 'Mengisi form pendaftaran yang telah disediakan.'])

<div class="step-line-horizontal d-none d-md-block"></div>

    
    @include('components.step', [
        'icon' => 'upload_surat.png',
        'title' => 'Upload surat',
        'desc' => 'Unggah surat permohonan magang dari kampus/sekolah.'
    ])
...
<div class="d-flex justify-content-center align-items-center gap-3 flex-wrap">
    @include('components.step', ['icon' => 'pengumuman.png', 'title' => 'Pengumuman', 'desc' => 'Tnggu surat balasan dari pihak DISKOMINFO.'])
...
<section class=" about-section bg-white py-5">
    <div class="container d-flex flex-column flex-md-row align-items-center">
        ...
        <div class="col-md-6">
            ...
            <p>Dinas Komunikasi dan Informatika Kota Bukittinggi (Diskominfo) merupakan instansi pemerintah daerah yang bertugas dalam bidang komunikasi, informatika, persandian, dan statistik...</p>
            <p>Dalam era digital saat ini, Diskominfo terus berkomitmen untuk mendorong transformasi digital di lingkungan pemerintahan dan masyarakat...</p>
        </div>
    </div>
</section>
...
<footer class="bg-primary text-white py-4">
    <div class="container d-flex flex-column flex-md-row justify-content-between">
        <div>
            <img src="{{ asset('img/logo-bukittinggi.png') }}" alt="Logo" style="height: 50px;">
            <p class="mt-2 mb-0">Dinas Komunikasi dan Informatika Kota Bukittinggi</p>
        </div>
        <div>
            <p class="fw-bold">Alamat:</p>
            <p>Jl. Veteran No. 1, Gulai Bancah, Kec. Mandiangin Koto Selayan,<br>Kota Bukittinggi, Sumatera Barat</p>
    ...
    <div class="text-center mt-3 small">
        © 2025 Dinas Komunikasi dan Informatika Kota Bukittinggi. All rights reserved.
    </div>
</footer>
