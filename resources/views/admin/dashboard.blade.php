...
<div class="container px-6 py-8 mx-auto">
        ...
        <div class="flex flex-wrap -mx-6">
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\User::where('role', 'user')->count() }}</h4>
            ...
            <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ \App\Models\User::where('role', 'admin')->count() }}</h4>
    ...
    <div class="mt-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <a href="{{ route('admin.pembimbing.index') }}" class="block p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-700">Manajemen Pembimbing</h3>
                        <p class="text-sm text-gray-500">Kelola data pembimbing</p>
                    </div>
                </div>
            </a>
            
            <a href="#" class="block p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center">
                    <div class="p-3 bg-green-600 bg-opacity-75 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Kelola pendaftar magang</p>
                    </div>
                </div>
            </a>
            ...
            <a href="#" class="block p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Kelola peserta magang aktif</p>
                    </div>
                </div>
            </a>
            ...
            <a href="#" class="block p-6 bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Kelola laporan dan sertifikat</p>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="mt-8">
        <h4 class="text-gray-600">Pengguna Terbaru</h4>
                        ...
                        <tbody class="bg-white divide-y">
                            ...
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <span class="px-2 py-1 font-semibold leading-tight rounded-full {{ $user->role == 'admin' ? 'text-green-700 bg-green-100' : 'text-blue-700 bg-blue-100' }}">
                                        {{ ucfirst($user->role) }}
                                    </span>
                                </td>
